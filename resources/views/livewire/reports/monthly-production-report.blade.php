<div>
    <div class="container mx-auto py-6" wire:poll.2s>
        <div class="p-6 bg-white text-black max-w-6xl mx-auto border border-gray-300 rounded shadow">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="border border-gray-300 p-1 text-right">{{ number_format($rm['qty'], 2) }}</td>
                                         ...
                                         @if($index === 0)
                                             ...
                                             <td class="border border-gray-300 p-1 text-center" rowspan="{{ $rawCount }}">{{ $row['weight_per_meter'] ? number_format($row['weight_per_meter'], 3) : '-' }}</td>
            ...
            <div class="mt-4 text-xs border border-gray-300 rounded p-3 bg-gray-50">
                @if($qualityReport)
                    ...
                    <div class="mb-2">{{ $qualityReport->quality_comment ?: 'This month all products were produced according to the standards and in a good quality, but we have observed some problems and recommended the following:' }}</div>
                ...
                @else
                    @if($grouped->count() > 0)
                        <div class="font-semibold underline mb-1">Comment of Quality</div>
                        <div class="mb-2">This month all products were produced according to the standards and in a good quality, but we have observed some problems and recommended the following:</div>
                        <div class="font-semibold underline mb-1">Problems:</div>

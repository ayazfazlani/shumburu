    ...
    <div class="flex items-center justify-between mb-2">
        <div class="flex items-center space-x-2">
            ...
            <div>
                ...
                <div class="text-xs">Weekly Sales Report</div>
            </div>
        </div>
        <div class="text-right text-xs">
            <div><span class="font-semibold">Document No:</span> SPF-WSR-001</div>
            <div><span class="font-semibold">Week:</span> {{ \Carbon\Carbon::parse($startDate)->format('d/m/Y') }} - {{ \Carbon\Carbon::parse($endDate)->format('d/m/Y') }}</div>
        </div>
    </div>
                ...
                @empty
                    <tr>
                        <td colspan="9" class="border border-black px-2 py-1 text-center text-gray-500">
                            No sales data found for the selected week
                        </td>
                    </tr>
                @endforelse

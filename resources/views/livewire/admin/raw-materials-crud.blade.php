                    ...
                    <div class="bx-modal-body">
                        <div class="bx-form">
                            ...
                            <div class="bx-form-group bx-form-full">
                                ...
                                <textarea wire:model.defer="description" class="bx-input bx-textarea @error('description') bx-input-error @enderror"
                                          rows="2" placeholder="Material description"></textarea>
                                @error('description')
                                    <span class="bx-error">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="bx-form-group">
                                ...
                                <input type="text" wire:model.defer="unit" class="bx-input @error('unit') bx-input-error @enderror"
                            ...
                            <div class="bx-form-group">
                                ...
                                <input type="number" step="0.001" wire:model.defer="quantity" class="bx-input @error('quantity') bx-input-error @enderror"
                                       placeholder="0.000" />
                                @error('quantity')
                                    <span class="bx-error">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="bx-form-group bx-form-full">
                                <div class="bx-checkbox-wrapper">
                                    ...
                                    <label for="is_active">Active Material</label>
                                </div>
                            </div>
                        </div>
                    </div>

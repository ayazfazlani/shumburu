...
<div class="bx-page bx-page-scrap-waste-record">
    <!-- ─── HEADER ─── -->
    <div class="bx-header">
        ...
        <div class="bx-card">
            <div class="bx-card-header">
                <h3>
                    ...
                    @if($isEditing) Edit Scrap/Waste Record @else New Scrap/Waste Record @endif
                </h3>
            </div>
            <div class="bx-card-body">
                @if ($showForm || $isEditing)
                    <form wire:submit.prevent="save" class="bx-form">
                        ...
                        <div class="bx-form-group bx-form-full">
                            ...
                            <input type="number" wire:model.defer="quantity_used" step="0.001" min="0.001"
                        ...
                        <div class="bx-form-group bx-form-full">
                            ...
                            <input type="number" wire:model.defer="quantity" step="0.001" min="0.001"
                ...
                @else
                    <div class="bx-empty-state bx-empty-state-sm">
                        <button class="bx-btn bx-btn-primary" wire:click="create">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @if($scrapWasteRecords->hasPages())
            <div class="bx-pagination-wrap">
                ...
                <div class="bx-pagination">
                    {{
                $scrapWasteRecords->links('components.pagination')
            }}
                </div>
            </div>
        @endif

                            ...
                            <tbody>
                                @foreach ($finishedGoods as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->outer_diameter ? number_format($item->outer_diameter, 2) : 'N/A' }}</td>
                                        ...
                                        <td>
                                            @if($item->stripe_color)
                                                <span class="badge" style="background-color: {{ $item->stripe_color }}; color: white;">
                                                    {{ $item->stripe_color }}
                                                </span>
                                            @else
                                                N/A
                                        ...
                                        <td>
                                            <span class="badge badge-{{ $item->purpose == 'for_stock' ? 'success' : 'warning' }}">

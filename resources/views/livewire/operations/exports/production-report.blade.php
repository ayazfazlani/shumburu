...
<head>
    ...
    <title>Daily Production Report - {{ $date }}</title>
    <style>
...
<body>
    <div class="header">
        ...
        <div class="report-title">Quality Control Daily Production of Pipe & Raw Material Reports</div>
        <div class="document-info">
            <div>Document no: S/P/E/PR QC:001</div>
            <div>Date: {{ \Carbon\Carbon::parse($date)->format('M d, Y') }}</div>
        </div>
    </div>

    <div class="filters">
        <div class="filter-item"><strong>Report Date:</strong> {{ \Carbon\Carbon::parse($date)->format('F d, Y') }}</div>
    ...
    <div class="quality-section">
        ...
        @if($qualityReport)
            <div style="margin-bottom: 10px;">{{ $qualityReport->quality_comment ?: 'Today all products were produced according to the standards and in a good quality, but we have observed some problems and recommended the following:' }}</div>
            ...
            @endif
        @else
            <div style="margin-bottom: 10px;">Today all products were produced according to the standards and in a good quality, but we have observed some problems and recommended the following:</div>
            <div style="font-weight: bold; text-decoration: underline; margin: 5px 0;">Problems:</div>

    ...
    <table>
        ...
        <tbody>
            @php
                ...
                $monthlyWaste = $finishedGoods->sum('waste_quantity');
                $monthlyGross = $monthlyProductWeight + $monthlyWaste;
            @endphp
            ...
            @empty
                <tr>
                    <td colspan="{{ 13 + count($lengths) }}" style="text-align: center; padding: 20px;">No production data found for the selected filters</td>
                </tr>
            @endforelse

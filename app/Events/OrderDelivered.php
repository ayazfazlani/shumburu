...
class OrderDelivered implements ShouldBroadcast
{
     ...
     */
    public function __construct(ProductionOrder $productionOrder, ?int $deliveredBy = null)
    {
    ...
    public function broadcastWith(): array
    {
        return [
            'order' => [
                ...
                'delivery_date' => $this->productionOrder->delivery_date?->format('Y-m-d'),
                'total_price' => $this->productionOrder->formatted_total_price,
            ],
            'type' => 'order_delivered',
            'message' => "Order #{$this->productionOrder->order_number} has been delivered to customer!",

...
class DailySalesReport extends Component
{
    ...
    public function render()
    {
        ...
        $deliveredOrders = ProductionOrder::with(['customer', 'items.product', 'payments'])
            ...
            ->whereBetween('delivery_date', [$startOfDay, $endOfDay])
        ...
        // Get deliveries for the selected date range
        ...
        return view('livewire.sales.daily-sales-report', [
    ...
    public function exportToPdf()
{
    ...
    $pdf = Pdf::loadView('livewire.sales.Exports.Daily-Sale-Report', $exportData)
         ->setPaper('a4', 'portrait'); // Changed to portrait for better fit
